...
import com.example.adisti.AdminTjslFragment.AdminTjslDetailLpjKegiatanFragment;
...
public class AdminTjslLpjKegiatanAdapter extends RecyclerView.Adapter<AdminTjslLpjKegiatanAdapter.ViewHolder> {
    Context context;
    List<ProposalModel>proposalModelList;
    PengajuInterface pengajuInterface;


    public AdminTjslLpjKegiatanAdapter(Context context, List<ProposalModel> proposalModelList) {
    ...
    @NonNull
    @Override
    public AdminTjslLpjKegiatanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_proposal, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdminTjslLpjKegiatanAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            cvMain.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Fragment fragment = new AdminTjslDetailLpjKegiatanFragment();
