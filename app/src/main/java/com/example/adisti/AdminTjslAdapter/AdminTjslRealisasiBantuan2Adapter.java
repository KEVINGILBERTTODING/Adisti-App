...
public class AdminTjslRealisasiBantuan2Adapter extends RecyclerView.Adapter<AdminTjslRealisasiBantuan2Adapter.ViewHolder> {
    Context context;
    List<ProposalModel>proposalModelList;
    PengajuInterface pengajuInterface;


    public AdminTjslRealisasiBantuan2Adapter(Context context, List<ProposalModel> proposalModelList) {
    ...
    @NonNull
    @Override
    public AdminTjslRealisasiBantuan2Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_proposal, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdminTjslRealisasiBantuan2Adapter.ViewHolder holder, int position) {
