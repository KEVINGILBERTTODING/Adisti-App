package com.example.adisti.AdminTjslAdapter;
...
import com.example.adisti.AdminTjslFragment.AdminTjslDetailPendapatTanggapanFragment;
...
public class AdminTjslPendapatTanggapanAdapter extends RecyclerView.Adapter<AdminTjslPendapatTanggapanAdapter.ViewHolder> {
    Context context;
    List<ProposalModel>proposalModelList;
    PengajuInterface pengajuInterface;


    public AdminTjslPendapatTanggapanAdapter(Context context, List<ProposalModel> proposalModelList) {
    ...
    @NonNull
    @Override
    public AdminTjslPendapatTanggapanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_proposal, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdminTjslPendapatTanggapanAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            cvMain.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Fragment fragment = new AdminTjslDetailPendapatTanggapanFragment();
