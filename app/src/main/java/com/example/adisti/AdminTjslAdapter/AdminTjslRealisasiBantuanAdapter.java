...
public class AdminTjslRealisasiBantuanAdapter extends RecyclerView.Adapter<AdminTjslRealisasiBantuanAdapter.ViewHolder> {
    Context context;
    List<ProposalModel>proposalModelList;
    PengajuInterface pengajuInterface;


    public AdminTjslRealisasiBantuanAdapter(Context context, List<ProposalModel> proposalModelList) {
    ...
    @NonNull
    @Override
    public AdminTjslRealisasiBantuanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_proposal, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdminTjslRealisasiBantuanAdapter.ViewHolder holder, int position) {
