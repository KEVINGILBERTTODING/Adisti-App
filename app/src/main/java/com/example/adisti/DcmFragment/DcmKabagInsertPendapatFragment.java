...
public class DcmKabagInsertPendapatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dcm_kabag_insert_pendapat, container, false);
        init(view);
    ...
    private void insertData() {
        ...
        if (etNamaKabag.getText().toString().isEmpty()) {
           ...
           etPendapatKabag.setError("Jabatan Tidak Boleh Kosong");
           etPendapatKabag.requestFocus();
            ...
            map.put("nama_kabag", RequestBody.create(MediaType.parse("text/plain"), etNamaKabag.getText().toString()));
            map.put("jabatan_kabag", RequestBody.create(MediaType.parse("text/plain"), etJabatanKabag.getText().toString()));
            ...
            dcmInterface.insertPendapatKabag(map).enqueue(new Callback<ResponseModel>() {
                @Override
        ...
        dcmInterface.getDetailUserById(userId).enqueue(new Callback<UserModel>() {
            ...
            public void onResponse(Call<UserModel> call, Response<UserModel> response) {
                if (response.isSuccessful() && response.body() != null) {
                    progressDialog.dismiss();
                    etNamaKabag.setText(response.body().getNamaLengkap());
                    etJabatanKabag.setText(response.body().getJabatan());
