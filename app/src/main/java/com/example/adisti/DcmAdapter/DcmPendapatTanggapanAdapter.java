package com.example.adisti.DcmAdapter;
...
import com.example.adisti.DcmFragment.DcmDetailPendapatTanggapanFragment;
...
public class DcmPendapatTanggapanAdapter extends RecyclerView.Adapter<DcmPendapatTanggapanAdapter.ViewHolder> {
    Context context;
    List<ProposalModel>proposalModelList;
    PengajuInterface pengajuInterface;


    public DcmPendapatTanggapanAdapter(Context context, List<ProposalModel> proposalModelList) {
    ...
    @NonNull
    @Override
    public DcmPendapatTanggapanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_proposal, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DcmPendapatTanggapanAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            cvMain.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Fragment fragment = new DcmDetailPendapatTanggapanFragment();
