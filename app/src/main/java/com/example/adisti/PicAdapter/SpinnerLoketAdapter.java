...
public class SpinnerLoketAdapter extends ArrayAdapter<LoketModel> {

   public SpinnerLoketAdapter(@NonNull Context context, List< LoketModel > loketModel){
    ...
    public String getNamaLoket(int position) {
